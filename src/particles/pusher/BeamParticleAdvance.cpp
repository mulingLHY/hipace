    ...
    const int slice, int const current_N_level)
{
    ...
    const int m_depos_order_z = Hipace::m_depos_order_z;
    const int psi_comp_p = (m_depos_order_z == 1) ? Comps[WhichSlice::Previous]["Psi"] : -1;
    const int ez_comp_p = (m_depos_order_z == 1) ? Comps[WhichSlice::Previous]["Ez"] : -1;
    const int bx_comp_p = (m_depos_order_z == 1) ? Comps[WhichSlice::Previous]["Bx"] : -1;
    const int by_comp_p = (m_depos_order_z == 1) ? Comps[WhichSlice::Previous]["By"] : -1;
    const int bz_comp_p = (m_depos_order_z == 1) ? Comps[WhichSlice::Previous]["Bz"] : -1;
