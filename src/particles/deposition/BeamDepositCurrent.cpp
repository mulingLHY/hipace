                     ...
                     const int which_slice, const int which_beam_slice, const bool only_highest)
{
    ...
    AMREX_ALWAYS_ASSERT_WITH_MESSAGE(Hipace::m_depos_order_z == 0 || Hipace::m_depos_order_z == 1 || Hipace::m_depos_order_z == 2,
        "Only order 0, 1 or 2 deposition is allowed for beam per-slice Ez interpolation");
